...
\end{align}
one of the properties of a function f\brak{x} is that if its differentiable then its continuous.i.e
\begin{align}
...
For a function f\brak{x,y} to be differentiable at $\brak{x_0,y_0}$
\begin{enumerate}
