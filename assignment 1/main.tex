...
$\Rightarrow$ probability of an item to be defective \hspace{0.5cm}= 5$\% \\
$\hspace*{3in} = 0.05\\
$\Rightarrow$ probability of an item to be non-defective=95$\%$
\begin{flushright}
= 1-0.05
\end{flushright}
...
\begin{flushright}
$\because$ probability of n independent
events happening simultaneously= $p_1 \times p_2 \times ...... p_{n-1} \times p_n$
\end{flushright}
...
$= (0.95)^{10}$ + $^{10}C_1 \times (0.95)^9 \times (0.05)$    \\
$=0.9139$\\
$=91.39 \%$
\begin{flushright}
