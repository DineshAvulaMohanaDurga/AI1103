...
\begin{align}
\pr{x<y<z}&=\int_{0}^{1} \int_{0}^{z} \int_{0}^{y} f\brak{x,y,z}\text{ dx dy dz}\\
&=\int_{0}^{1} \int_{0}^{z} 8yz \brak{\int_{0}^{y} x \text{ dx}}\text{ dy dz}\nonumber\\
&=\int_{0}^{1}4z\brak{\int_{0}^{z} y^3 \text{ dy}} \text{ dz}\nonumber\\
&=\int_{0}^{1} z^5 dz \nonumber\\
&=\frac{1}{6}
\end{align}
